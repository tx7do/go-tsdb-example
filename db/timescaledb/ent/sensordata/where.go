...
import (
	"go-tsdb-example/db/timescaledb/ent/predicate"
	"time"
...
func Time(v time.Time) predicate.SensorData {
	return predicate.SensorData(func(s *sql.Selector) {
...
func TimeEQ(v time.Time) predicate.SensorData {
	return predicate.SensorData(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldTime), v))
	})
}
...
func TimeNEQ(v time.Time) predicate.SensorData {
	return predicate.SensorData(func(s *sql.Selector) {
...
func TimeIn(vs ...time.Time) predicate.SensorData {
...
func TimeNotIn(vs ...time.Time) predicate.SensorData {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TimeGT(v time.Time) predicate.SensorData {
	return predicate.SensorData(func(s *sql.Selector) {
...
func TimeGTE(v time.Time) predicate.SensorData {
	return predicate.SensorData(func(s *sql.Selector) {
...
func TimeLT(v time.Time) predicate.SensorData {
	return predicate.SensorData(func(s *sql.Selector) {
...
func TimeLTE(v time.Time) predicate.SensorData {
	return predicate.SensorData(func(s *sql.Selector) {
